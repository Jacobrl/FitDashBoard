...
hist(daily_act$TotalSteps, main = "Histogram of Total Steps", xlab = "Total Steps Taken")
hist(daily_act$TotalDistance, main = "Histogram of Total Distance", xlab = "Total Distance")
hist(daily_act$TrackerDistance, main = "Histogram of Tracker Distance", xlab = "Tracker Distance")
hist(daily_act$LoggedActivitiesDistance, main = "Histogram of Logged Activities Distance", xlab = "Logged Activities Distance")
hist(daily_act$VeryActiveDistance, main = "Histogram of Very Active Distance", xlab = "Very Active Distance")
hist(daily_act$ModeratelyActiveDistance, main = "Histogram of Moderately Active Distance", xlab = "Moderately Active Distance")
hist(daily_act$LightActiveDistance, main = "Histogram of Light Active Distance", xlab = "Light Active Distance")
hist(daily_act$SedentaryActiveDistance, main = "Histogram of Sedentary Active Distance", xlab = "Sedentary Active Distance")
hist(daily_act$VeryActiveMinutes, main = "Histogram of Very Active Minutes", xlab = "Very Active Minutes")
hist(daily_act$FairlyActiveMinutes, main = "Histogram of Fairly Active Minutes", xlab = "Fairly Active Minutes")
hist(daily_act$LightlyActiveMinutes, main = "Histogram of Lightly Active Minutes", xlab = "Lightly Active Minutes")
hist(daily_act$SedentaryMinutes, main = "Histogram of Sedentary Minutes", xlab = "Sedentary Minutes")
hist(daily_act$Calories, main = "Histogram of Calories", xlab = "Calories")
