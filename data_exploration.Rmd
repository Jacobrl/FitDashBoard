...
# Creating the histograms
hist(hourly_Cal$Calories, main = "Histogram of Calories", xlab = "Total Calories (Regardless of User Id)")
```
...
# Creating the histograms
hist(hourly_Int$TotalIntensity, main = "Histogram of Total Intensity", xlab = "Total Intensity (Regardless of User Id)")
hist(hourly_Int$AverageIntensity, main = "Histogram of Average Itensity", xlab = "Total of Average Itensity (Regardless of User Id)")
```
